import pandas as pd
import numpy as np
df = pd.read_csv (r'/Users/vamshikiranmorlawar/Desktop/CS666A/CS666/Assignment_3_22111066/CPA/AES_Power_Trace.csv')
df1=df.to_numpy()
print (df1)
...
def number_of_ones(n):
    ...
    while n:
        ...
        n /= 2
    return c
hypothetical_model=np.empty([8938,256])
...
for i in range(256):
    if (i==keyy):
        plt.plot(range(1999),corr_matrix[i,:], 'r',linewidth=5)
    else:
        plt.plot(range(1999),corr_matrix[i,:], 'k', linewidth=2)
plt.show()